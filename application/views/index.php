...
<body>
	...
	<form action="<?php echo base_url('index.php/auth/auth_akses'); ?>" method="post">
	<div class="container-login100" style="background-color: black;">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			...
			<form class="login100-form validate-form">
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter NO Memeber">
					<input class="input100" type="text" name="username" placeholder="No member">
			...
			<br>
			<form action="<?php echo base_url('index.php/auth/registrasi'); ?>"> 
			<div class="container-login100-form-btn">
					<button class="login100-form-btn" >
						Registrasi 
					</button>
