				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="tab-content">
                          ...
                          <div align="center">
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url()."index.php/admin/update_member"; ?>">
                                <tr>  
                                  <th width="150">
                                  ...
                                  <th width="750">
                                    <div class="col-sm-10">
                                      <input type="text" autocomplete="off" required="required" class="form-control" id="no_member" name="no_member"  value="<?php echo $data['no_member']; ?>">
                                    </div>
                                  </div>
                                  </th>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <div class="col-sm-10">
                                      <input type="text" class="form-control" id="nama_member" required="required" name="nama_member"  value="<?php echo $data['nama_member']; ?>">
                                      </div>
                                  </td>
                                  </tr>
                                  <tr>
                                  ...
                                  <td>
                                      <div class="col-sm-10">
                                      <input type="text" class="form-control" id="alamat" required="required" name="alamat"  value="<?php echo $data['alamat']; ?>">
                                      </div>
                                  </td>
                                  </tr>
